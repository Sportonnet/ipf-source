...
public class LeagueScoreDetailsDaoImpl implements ILeagueScoreDetailsDao {
	...
	@Override
	public void createNewLeagueScoreDetails(
			LeagueScoreDetails leagueScoreDetails) {
		this.mongoTemplate.insert(leagueScoreDetails);
	}

	@Override
	public void createNewLeagueScoreDetails(String leagueName) {
		final LeagueScoreDetails leagueScoreDetails = new LeagueScoreDetails(
				leagueName);
		this.mongoTemplate.insert(leagueScoreDetails);
	}
	...
	public LeagueScoreDetails fetchUserChallenge(String leagueName,
		...
		final List<LeagueScoreDetails> leagueScoreDetails = getLeagueScoreDetailsRepository()
	...
	public void addChallengerPrediction(String leagueName, String fixtureId,
		...
		// final LeagueScoreDetails leagueScoreDetails =
		// fetchLeagueScoreDetails(leagueName);
	...
	/**
	 * @param leagueScoreDetailsRepository
	 *            the leagueScoreDetailsRepository to set
	 */
